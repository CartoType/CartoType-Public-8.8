...
/** A macro to define a Text literal with the same name as its value. */
#define TextName(aName) Text static const aName(u ## #aName,sizeof(u ## #aName) / sizeof(char16_t) - 1);
