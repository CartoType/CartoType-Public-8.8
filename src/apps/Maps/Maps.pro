...
unix:!macx: LIBS += -L$$PWD/../../main/platform/qt/CartoTypeQtMapRenderer/build64/release/ -lCartoTypeQtMapRenderer -L$$PWD/../../main/single_library/unix/bin/ReleaseLicensed/ -lcartotype -lcurl
