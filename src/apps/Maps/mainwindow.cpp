...
CartoType::Result MainWindow::InitCartoType()
    ...
    if (!error)
        error = LoadFont("DejaVuSans-Oblique.ttf");
    if (!error)
        error = LoadFont("DejaVuSans-BoldOblique.ttf");
    if (!error)
        error = LoadFont("DejaVuSerif.ttf");
    if (!error)
        error = LoadFont("DejaVuSerif-Bold.ttf");
    if (!error)
        error = LoadFont("DejaVuSerif-Italic.ttf");
    if (!error)
        error = LoadFont("DejaVuSerif-BoldItalic.ttf");
    if (!error)
